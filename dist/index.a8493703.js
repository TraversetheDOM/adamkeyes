 ...
 */ class BootstrapAnimation {
   ...
   */ #handleIntersection(entries, observer) {
        entries.forEach((entry)=>{
            if (entry.isIntersecting) {
                ...
                if (this.#target instanceof Element) observer.unobserve(this.#target);
            }
        });
    }
    /**
   ...
   */ #observeIntersection() {
        ...
        if (this.#target instanceof Element) observer.observe(this.#target);
    }
}
/**
 ...
 */ function animateOnIt() {
    const sections = /** @type {NodeList}*/ document.querySelectorAll(".animate");
...
},{}]},["1UrCN","lamKG"], "lamKG", "parcelRequire46e0")

//# sourceMappingURL=index.a8493703.js.map
